#!/usr/bin/env python3
"""
Simple ASR Script - Single File Input
Transcribes audio and computes WER/CER against reference text
"""
...
class SimpleASR:
    ...
    def check_dependencies(self) -> bool:
        ...
        try:
            ...
            logger.info("Please install required packages: pip install openai-whisper jiwer")
            return False
    ...
    def process_audio_file(self, audio_path: str, reference_text: str = None) -> dict:
...
def main():
    parser = argparse.ArgumentParser(description='Simple ASR with WER/CER calculation')
    ...
    results = asr.process_audio_file(args.audio_file, args.reference)
